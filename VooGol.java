...
public class VooGol implements Voo {
	private static final int TEMPO_VIAJEM = 210; // HORAS
	...
	public VooGol() {
		System.out.println("============VooGol====================");
		System.out.print("Horario atual" + horaAtualAmbiente());
	...
	private String tratadorHoraAtual(int hora, int minutos) {
		...
		if (minutos < NUMERO && (minutos < (NUMERO - NUMERO))) {
